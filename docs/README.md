...
| **Store preferences / UI locale** | [045](features/045-backend-store-preferences/README.md), [046](features/046-frontend-ui-locale/README.md), [088](features/088-backend-store-default-tax-rate/README.md), [089](features/089-frontend-store-tax-rate/README.md) | BE **045** + FE **046** done; BE **088** + FE **089** default tax rate done. |
| **Closed tickets / reimburse** | [072](features/072-backend-closed-tickets-reimburse/README.md), [073](features/073-frontend-closed-tickets-reimburse/README.md), [086](features/086-backend-cashier-own-reimburse/README.md), [087](features/087-frontend-cashier-own-reimburse/README.md), [084](features/084-backend-card-reimburse/README.md), [085](features/085-frontend-card-reimburse/README.md) | **072/073** done; **086/087** cashier-own done; **084/085** CARD deferred |
| **Transaction hold/void** | [082](features/082-backend-transaction-lifecycle/README.md), [083](features/083-frontend-transaction-lifecycle/README.md) | Deferred — product design |
| **Multi-tier pricing** | [090](features/090-backend-multi-tier-pricing/README.md) | Deferred — design needed; FE companion TBD |
| **Negative-stock notify** | [091](features/091-backend-negative-stock-notify/README.md), [092](features/092-frontend-negative-stock-notify/README.md) | Deferred — channel TBD |
...
| 085 | FE | Planned — Deferred | [README](features/085-frontend-card-reimburse/README.md) | [spec](features/085-frontend-card-reimburse/spec.md) · [plan](features/085-frontend-card-reimburse/plan.md) · [tasks](features/085-frontend-card-reimburse/tasks.md) |
| 086 | BE | Done | [README](features/086-backend-cashier-own-reimburse/README.md) | [spec](features/086-backend-cashier-own-reimburse/spec.md) · [plan](features/086-backend-cashier-own-reimburse/plan.md) · [tasks](features/086-backend-cashier-own-reimburse/tasks.md) |
| 087 | FE | Done | [README](features/087-frontend-cashier-own-reimburse/README.md) | [spec](features/087-frontend-cashier-own-reimburse/spec.md) · [plan](features/087-frontend-cashier-own-reimburse/plan.md) · [tasks](features/087-frontend-cashier-own-reimburse/tasks.md) |
| 088 | BE | Done | [README](features/088-backend-store-default-tax-rate/README.md) | [spec](features/088-backend-store-default-tax-rate/spec.md) · [plan](features/088-backend-store-default-tax-rate/plan.md) · [tasks](features/088-backend-store-default-tax-rate/tasks.md) |
| 089 | FE | Done | [README](features/089-frontend-store-tax-rate/README.md) | [spec](features/089-frontend-store-tax-rate/spec.md) · [plan](features/089-frontend-store-tax-rate/plan.md) · [tasks](features/089-frontend-store-tax-rate/tasks.md) |
| 090 | BE | Planned — Deferred (design needed) | [README](features/090-backend-multi-tier-pricing/README.md) | [spec](features/090-backend-multi-tier-pricing/spec.md) · [plan](features/090-backend-multi-tier-pricing/plan.md) · [tasks](features/090-backend-multi-tier-pricing/tasks.md) |
| 091 | BE | Planned — Deferred (channel TBD) | [README](features/091-backend-negative-stock-notify/README.md) | [spec](features/091-backend-negative-stock-notify/spec.md) · [plan](features/091-backend-negative-stock-notify/plan.md) · [tasks](features/091-backend-negative-stock-notify/tasks.md) |
